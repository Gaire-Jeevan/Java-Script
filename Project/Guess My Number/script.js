...
// making function for repetative code --> for displaying message
...
document.querySelector('.check').addEventListener('click', function () {
  ...
  if (!guess) {
    // if guess is 0 or no number as 0 is falshy value
...
document.querySelector('.again').addEventListener('click', function () {
  ...
  document.querySelector('.guess').value = ''; // guess to null
