...
TEST DATA 2: Julia's data [9, 16, 6, 8, 3], Kate's data [10, 5, 6, 1, 4] GOOD LUCK 
*/
...
const checkDogs = function (dogsJulia, dogsKate) {
  ...
  dogs.forEach(function (dog, i) {
    if (dog >= 3) {
      console.log(`Dog numbre ${i} is an adult, and is ${dog} yearls old`);
    } else {
      console.log(`Dog numbre ${i} is still a puppy 🐶`);
    }
  });
};
...
// 6.
const checkEatingOkay = dog => dog.curFood * 0.9 && dog.recFood * 1.;
